  ...
  return (
    <div>
      <PageHeader
        ...
        titulo="Nosso processo de verificação"
        subtitulo="Cada relógio que passa pela Concept Watch é submetido a um processo de verificação criterioso antes de chegar até você. Veja como funciona."
        breadcrumb={[{ label: "Catálogo", href: "/catalogo" }, { label: "Verificação" }]}
      />
